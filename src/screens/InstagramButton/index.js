...
PushNotification.configure({
    ...
    requestPermissions: true,
      ...
      sendMessage = (myTitle, myMessage) =>{
        console.log("5555555",myTitle,myMessage)
    ...
    render() 
{
    return (
        <View style={{ flex:1,justifyContent:"center",alignItems:"center" }}>
            <View style={{backgroundColor:"green", borderRadius:20, padding:15}}>
            <TouchableOpacity onPress={() => this.instagramLogin.show()}>
                <Text style={{ color: 'white' }}>Login via Instagram</Text>
               {/* <Text style={{ color: 'green' }}>{this.state.token}</Text> */}
            </TouchableOpacity>
            <InstagramLogin
                ref={ref => (this.instagramLogin = ref)}
                appId='931cca1d0c154de3aafd83300ff8b288'
                ...
                onLoginFailure={(data) => console.log("data---",data)}
            />
            </View>
            <View style={{backgroundColor:"blue", borderRadius:20, padding:15, marginVertical:20}}>
                <TouchableOpacity onPress={()=>this.sendMessage("Hello","This is notificationnnnnn")}>
